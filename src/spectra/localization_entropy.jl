...
function heatmap_M_vs_A_2d(
    ...
    # Plot the heatmap
    As_edges_heatmap = collect(range(0.0, A_max_range, length=101))  # For heatmap
    Rs_edges_heatmap = collect(range(R_min, R_max, length=101))      # For heatmap
    ...
    heatmap!(ax, As_bin_centers_heatmap, Rs_bin_centers_heatmap, grid; colormap=Reverse(:gist_heat))
