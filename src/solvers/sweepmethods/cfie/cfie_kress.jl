...
"""
    build_reduced_orbit_infos(Ifund::Vector{Int},full_to_fund::Vector{Int},fund_to_full::Vector{Vector{Int}},fund_to_scale::Vector{Vector{Complex{T}}},global_to_block::Vector{Int},global_to_local::Vector{Int}) where {T<:Real}
