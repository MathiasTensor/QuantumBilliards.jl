...
@inline symmetry_order(::BilliardGeometry.DiagonalReflection)=2
@inline symmetry_order(::BilliardGeometry.AntiDiagonalReflection)=2
...
@inline symmetry_node_multiple(::BilliardGeometry.DiagonalReflection)=4
@inline symmetry_node_multiple(::BilliardGeometry.AntiDiagonalReflection)=4
...
"""
    symmetry_index_orbits(::Type{T},N::Int,sym::BilliardGeometry.DiagonalReflection) where {T<:Real} → SymmetryOrbitMap{T}
...
* `orbits::SymmetryOrbitMap{T}`: Orbit map with orbit size `2` and reduced size `N/2`.
"""
function symmetry_index_orbits(::Type{T},N::Int,sym::BilliardGeometry.DiagonalReflection) where {T<:Real}
...
"""
    symmetry_index_orbits(::Type{T},N::Int,sym::BilliardGeometry.AntiDiagonalReflection) where {T<:Real} → SymmetryOrbitMap{T}
...
* `orbits::SymmetryOrbitMap{T}`: Orbit map with orbit size `2` and reduced size `N/2`.
"""
function symmetry_index_orbits(::Type{T},N::Int,sym::BilliardGeometry.AntiDiagonalReflection) where {T<:Real}
...
"""
    symmetry_index_orbits(::Type{T},pts::Vector{BoundaryPoints{T}},sym::BilliardGeometry.DiagonalReflection) where {T<:Real} → SymmetryOrbitMap{T}
...
"""
function symmetry_index_orbits(::Type{T},pts::Vector{BoundaryPoints{T}},sym::BilliardGeometry.DiagonalReflection) where {T<:Real}
    maps=[symmetry_index_orbits(T,p,sym) for p in pts]
    return _combine_component_orbits(T,pts,maps)
end

"""
    symmetry_index_orbits(::Type{T},pts::Vector{BoundaryPoints{T}},sym::BilliardGeometry.AntiDiagonalReflection) where {T<:Real} → SymmetryOrbitMap{T}
...
* `orbits::SymmetryOrbitMap{T}`: Global two-element reflection orbit map.
"""
function symmetry_index_orbits(::Type{T},pts::Vector{BoundaryPoints{T}},sym::BilliardGeometry.AntiDiagonalReflection) where {T<:Real}
    maps=[symmetry_index_orbits(T,p,sym) for p in pts]
    return _combine_component_orbits(T,pts,maps)
end
...
@inline symmetry_index_orbits(::Type{T},pts::BoundaryPoints,sym::BilliardGeometry.DiagonalReflection) where {T<:Real}=symmetry_index_orbits(T,length(pts),sym)
@inline symmetry_index_orbits(::Type{T},pts::BoundaryPoints,sym::BilliardGeometry.AntiDiagonalReflection) where {T<:Real}=symmetry_index_orbits(T,length(pts),sym)
