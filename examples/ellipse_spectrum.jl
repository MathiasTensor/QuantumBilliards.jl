...
if !isdir("Ellipse/Ellipse_Wavefunctions")
    mkdir("Ellipse/Ellipse_Wavefunctions")
end

if !isdir("Ellipse/Ellipse_Husimi")
    mkdir("Ellipse/Ellipse_Husimi")
end

if !isdir("Ellipse/Ellipse_Momentum")
    mkdir("Ellipse/Ellipse_Momentum")
end

if !isdir("Ellipse/Ellipse_Spectra")
    mkdir("Ellipse/Ellipse_Spectra")
end

if !isdir("Ellipse/Ellipse_Eigenvalues")
    mkdir("Ellipse/Ellipse_Eigenvalues")
end
...
billiard, basis = make_ellipse_and_basis(3.0, 2.0)

fig = Figure()
ax = Axis(fig[1, 1], aspect = DataAspect())
plot_boundary!(ax, billiard)
save("Ellipse/ellipse_boundary.png", fig)
...
save("Ellipse/ellipse_basis_test.png", f)
...
open("Ellipse/ellipse_solver_logs.txt", "w") do io
    redirect_stdout(io)
...
try
    ...
    save("Ellipse/ellipse_acc_solver_test.png", f)
catch e
    println(e)
end
...
try
    ...
    save("Ellipse/ellipse_dm_solver_test.png", f)
catch e
    println(e)
end
...
try
    ...
    save("Ellipse/acc_test_state.png", f_acc)
catch e
    println(e)
end
...
try
    ...
    save("Ellipse/dm_test_state.png", f_dm) 
catch e
    println(e)
end
...
f = Figure()
ax = Axis(f[1,1], title="Ellipse_$(nameof(typeof(basis)))")
...
display(f)
save("Ellipse/Ellipse_Spectra/ellipse_spectrum_$(L1)_$(L2).png", f)
save_numerical_ks_and_tensions!(ks, tens, "Ellipse/Ellipse_Eigenvalues/ellipse_eigenvalues_$(L1)_$(L2).csv")
...
ks, _ = read_numerical_ks_and_tensions("Ellipse/Ellipse_Eigenvalues/ellipse_eigenvalues_$(L1)_$(L2).csv")
...
for i in eachindex(ks) 
    ...
    try
        ...
        save("Ellipse/Ellipse_Wavefunctions/$(ks[i])_probability.png", f_probability)
        save("Ellipse/Ellipse_Wavefunctions/$(ks[i])_probability_full.png", f_probability_full)
        save("Ellipse/Ellipse_Wavefunctions/$(ks[i])_wavefunction.png", f_wavefunction)
        save("Ellipse/Ellipse_Wavefunctions/$(ks[i])_wavefunction_full.png", f_wavefunction_full)
        save("Ellipse/Ellipse_Husimi/$(ks[i])_husimi.png", f_husimi)
        save("Ellipse/Ellipse_Momentum/$(ks[i])_momentum.png", f_momentum)
...
if billiard_polygon_check
    ...
    println(QuantumBilliards.compute_area(billiard.full_boundary[1])) ## It's correct = pi*a*b
    wait(display(fig))
end
